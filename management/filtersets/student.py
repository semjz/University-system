...
class StudentFilterSet(filters.FilterSet):
    ...
    national_code = filters.CharFilter(field_name="user__national_code", label="National Code")
    school = filters.CharFilter(field_name="school__name", lookup_expr="exact", label="School")
    ...
    major = filters.CharFilter(field_name="major__name", lookup_expr="exact", label="Major")
